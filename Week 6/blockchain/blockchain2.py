...
6bbeccca0fb6d373675ea2029db98a13c848f562073f2ef00c9c401cb244404309f772af5563e0e51f958b4caa1baab4
539a9598cbb33f5f987007eb092d34a543bafd4b6d3c3d3e
0f073399c5bbd436ce2e8e84175730f647a7c597903fc310fde18d4eb91f7f3d4553b6d45f3064d2aabbece7ec9adbcc
762d7e1ed7a941362090833ec6bc23b6856572bb82c6701a
'''

from collections import OrderedDict
from ecdsa import SigningKey, NIST384p, VerifyingKey
import binascii
from KeyGenerator import generateKeyPair, verifyingExisting
...
class Blockchain:
    ...
    def submit_transaction(self, sender_address, recipient_address, value, signature, nonce=None,comment=None):
        """
        ...
        try:
            ...
            #Manages transactions from wallet to another wallet
                ...
                print('sender addres',sender_address)
                ...
                print('value', value)
                transaction = Transaction(sendervk, receivervk,value, comment,nonce)
                transaction_verification = transaction.validate(signature, sendervk)
                if transaction_verification:
                    transaction1 = OrderedDict({'sender_address': sender_address, 
                                        'recipient_address': recipient_address,
                                        'value': value, 'nonce':nonce})
                    self.past_transactions.append(transaction1)
                    return len(self.chain) + 1
                else:
                    return False
    ...
    def proof_of_work(self):
        ...
        nonce = 0
        while self.valid_proof(self.past_transactions, last_hash, nonce) is False:
            nonce += 1
...
def new_transaction():
    ...
    required = ['sender_address', 'recipient_address','amount','comment', 'signature']
    if not all(k in values for k in required):
        print(values.keys())
        return 'Missing values', 400
    # Create a new Transaction
    print('test new transaction')
    transaction_result = blockchain.submit_transaction(values['sender_address'],
     values['recipient_address'], values['amount'], values['signature'], values['comment'])
    print('tested new transaction')
